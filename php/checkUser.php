        ...
        <body>
            ...
            <div style="margin-left:21%;padding:1px 16px;height:1000px;">
                <div class="boxCasefile">
                    <h2><?php echo "Client found, data printout:"?></h2>
                    <?php
                        ...
                        echo "<strong style=\"color:#fcba03\";>Cellphone: </strong>" . $row['cell'];
...
<?php
        ...
        <head>
            ...
            <script src="js/scripts.js"></script>
            <script src="js/email.js"></script>
            <title>Investigatos' Index</title>
        </head>
        <body>
            <ul>
...
<?php
            ...
            sleep(5);
            header("Location: checkUserPage.php");
        }
?>